...
package org.lucky.transport.netty.handler;
...
import org.lucky.transport.JProtocolHeader;
import org.lucky.transport.payload.BytesHolder;
...
public class ProtocolEncoder extends MessageToByteEncoder<BytesHolder> {
    ...
    protected void encode(ChannelHandlerContext ctx, BytesHolder msg, ByteBuf out) throws Exception {
        if (msg instanceof LRequestBytes) {
            doEncodeRequest((LRequestBytes) msg, out);
    ...
    private void doEncodeRequest(LRequestBytes request, ByteBuf out) {
