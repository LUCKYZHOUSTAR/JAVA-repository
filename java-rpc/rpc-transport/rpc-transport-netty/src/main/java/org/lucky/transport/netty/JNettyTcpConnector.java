...
import org.lucky.transport.exception.ConnectFailedException;
import org.lucky.transport.netty.handler.IdleStateChecker;
import org.lucky.transport.netty.handler.ProtocolDecoder;
import org.lucky.transport.netty.handler.ProtocolEncoder;
import org.lucky.transport.netty.handler.connector.ConnectionWatchdog;
import org.lucky.transport.netty.handler.connector.ConnectorHandler;
import org.lucky.transport.netty.handler.connector.ConnectorIdleStateTrigger;
...
public class JNettyTcpConnector extends NettyTcpConnector {
    ...
    public JConnection connect(UnresolvedAddress address, boolean async) {
        ...
        final LChannelGroup group = group(address);
