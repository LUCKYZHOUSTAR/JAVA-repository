...
public final class JConstants {
    ...
    public static final int SUGGESTED_CONNECTION_COUNT = AVAILABLE_PROCESSORS;

    /** Metrics csv reporter */
    public static final boolean METRIC_CSV_REPORTER =false;
    /** Metrics csv reporter directory */
    public static final String METRIC_CSV_REPORTER_DIRECTORY ="";
    /** Metrics reporter period */
    public static final int METRIC_REPORT_PERIOD = 15;
}
