...
public class OneByOneBoot {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //1执行完，才开始执行2
        EventHandlerGroup<Request> eventHandlerGroup = disruptor.handleEventsWith(new ConsumerHandler());
        eventHandlerGroup.then(new ConsumerHandler2());
