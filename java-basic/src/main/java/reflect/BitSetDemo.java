...
/**
 * 1.     统计一组大数据中没有出现过的数；         将这组数据映射到BitSet，然后遍历BitSet，对应位为0的数表示没有出现过的数据。 2.     对大数据进行排序；
 *         将数据映射到BitSet，遍历BitSet得到的就是有序数据。 3.     在内存对大数据进行压缩存储等等。        
 * 一个GB的内存空间可以存储85亿多个数，可以有效实现数据的压缩存储，节省内存空间开销。
 * <p>
 * ---------------------
 * <p>
 * 本文来自 caiandyong 的CSDN 博客 ，全文地址请点击：https://blog.csdn.net/caiandyong/article/details/51581160?utm_source=copy
 */

/**
 * @Author:chaoqiang.zhou
 * @Date:Create in 下午5:00 2018/9/30
 */
