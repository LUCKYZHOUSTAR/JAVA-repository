package cmc.lucky.basic.production.client.connector;


import cmc.lucky.basic.production.ConnectionWatchdog;
import cmc.lucky.basic.production.common.Acknowledge;
import cmc.lucky.basic.production.common.Message;
import cmc.lucky.basic.production.common.NativeSupport;
import cmc.lucky.basic.production.common.NettyCommonProtocol;
import cmc.lucky.basic.production.common.exception.ConnectFailedException;
import cmc.lucky.basic.production.server.acceptor.AcknowledgeEncoder;
...
public class DefaultCommonClientConnector extends NettyClientConnector {
        ...
        final ConnectionWatchdog watchdog = new ConnectionWatchdog(boot, timer, port, host) {
            ...
            public ChannelHandler[] handlers() {
                return new ChannelHandler[]{
                        ...
                        //解码器--》发送一个act的响应包信息--出去的是bytebuf的类型
                        idleStateTrigger,
                        //message的解码器操作
                        new MessageDecoder(),
                        //编码器--消息操作
    ...
    protected EventLoopGroup initEventLoopGroup(int nWorkers, ThreadFactory workerFactory) {
        return NativeSupport.isNativeEPollAvailable() ? new EpollEventLoopGroup(nWorkers, workerFactory) : new NioEventLoopGroup(nWorkers, workerFactory);
    }
