...
import com.lucky.task.client.service.DefaultConsumerProcessor;
...
public class JobClientScheduler {
    ...
    public JobClientScheduler(ServerOptions serverOptions) {
        ...
        serverHandler.setProcessor(new DefaultConsumerProcessor());
        handlerc.setHandlers(new Handler[]{serverHandler});
